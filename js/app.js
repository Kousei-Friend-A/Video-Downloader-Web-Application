    ...
    var t, e = {
            ...
            590: (t, e, n) => {
                ...
                var w = x({
                    ...
                    data: function() {
                        return {
                            typeFile: this.el.url[0].name.includes("JPG")
                        }
                    },
                    methods: {
                    ...
                    return n("li", {
                        ...
                        staticClass: "multi__btn",
                        on: {
                            click: function(e) {
                                return e.preventDefault(), t.onDownload(t.el.url[0].url)
                            }
                        }
                    }, [t._v("\n        Download\n    ")])])
                }), [], !1, null, null, null);
                ...
                var O = x({
                            ...
                            if (this.meta.diffConverter && !1 === this.meta.diffConverterHasDiff)
                                for (var t = 0; t < this.url.length; t++)
                                    if (this.url[t].url && -1 !== this.url[t].url.indexOf("//du.sf-converter.com/")) {
                                        this.url[t].url += "&b=" + encodeURIComponent("https://ossrhydonr.com/4/3153682/");
                                        break
                                    }
                    ...
                    methods: {
                        download: function(t) {
                            return !this.meta.isSsYoutube || !0 !== this.meta.diffConverterHasDiff && void 0 !== this.meta.diffConverterHasDiff || /* window.open("https://ossrhydonr.com/4/3153682/")*/ this.trackDownload(t), setTimeout((function() {
                                        ...
                                        case 2:
                                            e.multi = null, e.results = null, e.loading = !0, e.trackLinkSubmit(), axios.post("https://api.savef.net/api/convert", {
                                                ...
                                                e.loading = !1, !Array.isArray(n) && r ? e.results = {
                                                    ...
                                                    /* window.open("https://ossrhydonr.com/4/3153682/")*/ 
                                                }), 2e3), e.iSsYoutube = !1
                                            })).catch((function() {
                                                e.loading = !1
                                            }));
